...
const COMPONENTS = {
  ...
  a: withClass(
    "a",
    "text-neutral-900 underline underline-offset-2 dark:text-neutral-50",
  ),
  blockquote: withClass(
    "blockquote",
    "border-l-2 border-neutral-900 pl-4 dark:border-neutral-50",
  ),
  ...
  tr: withClass(
    "tr",
    "m-0 border-t p-0 even:bg-neutral-100 dark:even:bg-neutral-800",
  ),
